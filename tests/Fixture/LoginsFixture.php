...
class LoginsFixture extends TestFixture
{
    ...
    public $fields = [
        'login_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['login_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
